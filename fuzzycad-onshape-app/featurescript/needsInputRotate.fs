...
defineFeature(function(
    ...
    }
    {
        ...
        // hand-drawn outline Proposed uses, just recolored black -- the
        // old sparse/incomplete look is retired. Uncertainty is now
        // signaled by the grey-faded original + red angle callout +
        // warning icon instead of by the candidate geometry itself
        // looking unfinished.
        //
        //////////////////////////////////////////////////////////////////
