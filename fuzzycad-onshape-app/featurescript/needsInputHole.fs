...
//
// Geometry logic (NewBodyOperationType.REMOVE + "booleanScope") is
// still UNCONFIRMED, same as proposedHole.fs -- test that file first,
// INCLUDING its safety check that the original body doesn't get cut
// too, before trusting this sibling.
//
// REWRITTEN to match proposedHole.fs's hidden-"accepted"-param
...
// black-instead-of-blue color choice. The depth dimension arrow is kept
// (drawDimensionArrow, copied from proposedHole.fs) but now drawn in
// black to match.
//
...
export const fuzzycadNeedsInputHole = defineFeature(function(context is Context, id is Id, definition is map)
    ...
    }
    {
        ...
        // rationale. Direction (which way the cut goes) is still real
        // and worth showing; the depth number itself is not.
...
//////////////////////////////////////////////////////////////////////
//
// FILLED DIMENSION ARROW (copied verbatim from proposedHole.fs)
//
//////////////////////////////////////////////////////////////////////
